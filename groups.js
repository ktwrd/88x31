export const data = [
    ...
    {
        name: 'powered by',
        expression: /^(emacs|power-button|powered|made_with|made(on|with)|vscodium|php|nts_iis|msfrontpage2000|hackerpowered|twopaws|notepad|button_np|redhat|win98_891|thevoidpowered-by-djbdns)/gi
    },
    {
        name: 'people',
